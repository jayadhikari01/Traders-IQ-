...
// 1. Firebase Initialization with your provided details
if (!admin.apps.length) {
    admin.initializeApp({
        credential: admin.credential.cert({
            projectId: "traders-iq-app-f5169",
            clientEmail: "firebase-adminsdk-f5169@traders-iq-app-f5169.iam.gserviceaccount.com",
            // I have properly formatted your key below
...
export default async function handler(req, res) {
    ...
    try {
        // Read raw body for security verification
        const chunks = [];
        ...
        // Security check: Validate Lemon Squeezy signature
        ...
        if (eventName === 'order_created' || eventName === 'subscription_created') {
            if (userId) {
                ...
                return res.status(200).send('User upgraded successfully');
            }
        }
